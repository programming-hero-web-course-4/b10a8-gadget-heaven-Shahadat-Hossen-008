...
export default function ProductsDetails() {
  ...
  return (
    <div className="bg-banner_color text-white text-center relative h-[45vh] mb-80 z-10">
      ...
      <div className=" bg-white text-black flex justify-between items-center absolute top-1/3 left-[15%] z-50 mt-12 p-5 gap-6 rounded-xl shadow-xl">
        <div>
          ...
          <div>
           ...
           <h1 className="text-2xl font-bold mb-4">{product_title}</h1>
            ...
            <button className="btn bg-banner_color text-white rounded-3xl items-center">Add To Card<CiShoppingCart className="text-2xl font-bold" /></button>
